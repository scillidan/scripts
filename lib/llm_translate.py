...
#   uv run llm_translate.py --host http://127.0.0.1:8080 --model gemma-3-4b-it-qat --input English --output Chinese --prompt quick --original-text "Alice was beginning to get very tired..."
#   uv run llm_translate.py --host http://127.0.0.1:8080 --model gemma-3-12b-it --input English --output Chinese --prompt serious --original-text "Alice was beginning to get very tired..."
#   uv run llm_translate.py --host http://127.0.0.1:8080 --model gemma-3-4b-it-qat --auto-mode all2zh-cn --auto-mode zh-cn2en "The quick brown fox jumps over the lazy dog."
#   uv run llm_translate.py --host http://127.0.0.1:8080 --model gemma-3-4b-it-qat --auto-mode all2zh-cn --auto-mode zh-cn2en "敏捷的棕色狐狸跳过懒惰的狗。"
#   echo "..." | uv run llm_translate.py ... --stdin
#   cat file.txt | uv run llm_translate.py ... --stdin
#
# Changelog:
